...
public class JogoDosDados extends JFrame{
	...
	public JogoDosDados() {
		...
		lerDados = new String[c]; // cria o array com o temanho do ficheiro
...
//North #######################################################################################################################
		...
		labelCE = new JLabel("   Estamos a testes se Pertence ou Não Pertence ao BloomFilter. Deve Pertencer se a Sequenceia for entre 11111-26666");
...
//South #######################################################################################################################
	...
	public void readNJogo() throws FileNotFoundException {
		File file = new File("..//ProjetoFinalMPEI//src//JogoFinal//NumeroDeFicheiros.txt");
		Scanner sc = new Scanner(file);
		nJogos = sc.nextInt();
		sc.close();
		}
	
	public void writeNJogo() throws IOException {
	    PrintWriter pw = new PrintWriter(new FileWriter("..//ProjetoFinalMPEI//src//JogoFinal//NumeroDeFicheiros.txt"));
	    pw.println(nJogos);
		pw.close();
	}
...
///////Para testar se Pertence ou Não Pertence///////////////////////////////////////////////////////////////////////////////////
	
	public int readSizeFile() throws FileNotFoundException {
		File file = new File("..//ProjetoFinalMPEI//src//Teste_BloomFilter_ComOJogo//RegistoDados.txt");
		Scanner sc = new Scanner(file);
		int i = 0;
		while(sc.hasNext()) {
			i++;
	...
	public void readDataBase() throws IOException {
		...
		Scanner sc = new Scanner(file);
		int i = 0;
		while(i < c) {  // igual ao numero de elem no ficheiro
